...
namespace procman
{
    ...
    /* Gonzo: renders the detritus coldness-percentage column. Displays
     * the raw percentage (0-100, sourced from the kernel's own
     * Referenced/Rss page-table accounting) for real data, or an
     * italic "N/A" for the -1 sentinel (no detritus data for this
     * pid), matching the existing memory_size_na_cell_data_func "N/A"
     * convention used elsewhere in this file for not-applicable
     * numeric values. */
